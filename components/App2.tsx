...
function EnergyChart({
  ...
  const series: {
    ...
    },
    {
      ...
      color: "var(--chart-2, #78c9a8)",
    },
    {
      key: "v2gDischarge",
      label: t("V2G 방전", "V2G Discharging"),
      color: "var(--energy-discharge, #f2a65a)",
    },
  ];
    ...
    >
      <div className="chart-plot">
        ...
        >
          ...
          <CartesianGrid
            stroke="var(--chart-grid, #e8ece9)"
            strokeDasharray="3 5"
            vertical={false}
          />
          <XAxis
            dataKey="hour"
            tick={{ fill: "var(--text-secondary, #77817c)", fontSize: 9 }}
            axisLine={false}
            tickLine={false}
            interval={0}
            minTickGap={0}
          ...
          />
          <YAxis
            tick={{ fill: "var(--text-secondary, #77817c)", fontSize: 11 }}
            axisLine={false}
            tickLine={false}
          ...
          />
          <ReferenceLine y={0} stroke="var(--border-strong, #b7c1bc)" />
          <Line
            type="linear"
            dataKey="fixedBase"
          ...
          <Bar
            ...
            fill="var(--energy-discharge, #f2a65a)"
            radius={[3, 3, 0, 0]}
            barSize={7}
