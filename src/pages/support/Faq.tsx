...
const FAQS = [
  { q: 'V2G 참여 시 배터리에 무리가 가지 않나요?', a: '배터리 보호 모드를 켜두면 설정한 최소 보장 배터리 아래로는 방전되지 않으며, 배터리 열화를 최소화하는 방식으로 방전량을 제어합니다.' },
  ...
  { q: '커넥티드카 연결은 필수인가요?', a: '커넥티드카로 연결하면 실시간 배터리 잔량 조회와 원격 충전 제어가 가능해지며, 연결하지 않아도 수동으로 참여할 수 있습니다.' },
