...
export const NOTIFICATIONS: AppNotification[] = [
  { id: 'nt-001', type: '충전 완료', title: '충전이 완료되었습니다', message: '아이오닉 6이 목표 SOC 80%까지 충전되었습니다.', createdAt: '2026-07-30 07:12', read: false, detail: '함덕해수욕장 충전소에서 진행된 충전이 완료되었습니다. 총 32.4kWh를 충전했으며 1,280P가 적립되었습니다.' },
  ...
  { id: 'nt-005', type: '예약 알림', title: '충전소 예약이 1시간 남았습니다', message: '중문관광단지 충전소 예약 시간이 다가오고 있습니다.', createdAt: '2026-07-28 15:00', read: true, detail: '예약 시간: 16:00 / 예상 체류 시간 90분 / 목표 SOC 80%' },
  { id: 'nt-006', type: '배터리 경고', title: '배터리 잔량이 낮습니다', message: '현재 SOC 18%, 최소 보장 SOC에 근접했습니다.', createdAt: '2026-07-27 06:40', read: true, detail: '설정된 최소 보장 SOC 20%에 근접했습니다. 충전소 방문을 권장합니다.' },
  ...
  { id: 'nt-011', type: '충전 완료', title: '충전이 완료되었습니다', message: 'EV6가 목표 SOC 75%까지 충전되었습니다.', createdAt: '2026-07-23 21:44', read: true, detail: '애월 카페거리 충전소에서 진행된 충전이 완료되었습니다.' },
